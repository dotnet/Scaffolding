...
namespace Microsoft.DotNet.Scaffolding.Shared
{
    internal static class StringUtil
    {
        ...
        /// </summary>
        internal static (string normalizedSource, string normalizedSnippet, string normalizedBlock) NormalizeTextForMatching(
            string source,
            string snippet,
            string block)
        {
        ...
        internal static bool DoesCheckBlockExistAfterSnippet(string source, string snippet, string checkBlock, int searchLength = 500)
        {
            ...
            if (replaceIndex >= 0)
            {
                ...
                return searchAfter.ContainsIgnoreCase(checkBlock);
            }
            return false;
        }
    }
