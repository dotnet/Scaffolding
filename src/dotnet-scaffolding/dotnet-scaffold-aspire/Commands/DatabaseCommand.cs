...
namespace Microsoft.DotNet.Tools.Scaffold.Aspire.Commands
{
    internal class DatabaseCommand : ICommandWithSettings
    {
        ...
        internal async Task<Dictionary<string, string>> GetAppHostPropertiesAsync(DatabaseCommandSettings commandSettings, ICodeService codeService)
        {
        ...
        internal Dictionary<string, string> GetApiProjectProperties(DatabaseCommandSettings commandSettings)
        {
            var codeModifierProperties = new Dictionary<string, string>();
