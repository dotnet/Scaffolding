...
namespace Microsoft.DotNet.Tools.Scaffold.AspNet.Commands
{
    ...
    public static class GetCmdsHelper
    {
        ...
        internal static Parameter DatabaseProvider = new() { Name = "--dbProvider", DisplayName = "Database Provider", Description = "", Required = false, Type = BaseTypes.String, PickerType = InteractivePickerType.CustomPicker, CustomPickerValues = [.. AspNetDbContextHelper.DbContextTypeDefaults.Keys] };
        internal static Parameter DatabaseProviderRequired = new() { Name = "--dbProvider", DisplayName = "Database Provider", Description = "", Required = true, Type = BaseTypes.String, PickerType = InteractivePickerType.CustomPicker, CustomPickerValues = [.. AspNetDbContextHelper.DbContextTypeDefaults.Keys] };
