            ...
            if (this.Errors.HasErrors == false)
            {
                ...
                if ((ModelValueAcquired == false))
                {
                    ...
                    if ((string.IsNullOrEmpty(parameterValue) == false))
                    {
                        ...
                        {
                            this.Error("The type 'Microsoft.DotNet.Tools.Scaffold.AspNet.Models.BlazorCrudModel' of the parameter 'Model' did not match the type of the data passed to the template.");
                        }
                    }
                }
                if ((ModelValueAcquired == false))
