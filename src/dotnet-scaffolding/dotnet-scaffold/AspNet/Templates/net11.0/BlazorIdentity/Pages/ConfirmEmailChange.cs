...
namespace Microsoft.DotNet.Tools.Scaffold.AspNet.Templates.net11.BlazorIdentity.Pages
{
    ...
    public partial class ConfirmEmailChange : ConfirmEmailChangeBase
    {
        /// <summary>
        ...
        {
            this.Write("@page \"/Account/ConfirmEmailChange\"\r\n\r\n@using System.Text\r\n@using Microsoft.AspNe" +
...
if (!string.IsNullOrEmpty(Model.DbContextNamespace))
{
            ...
            this.Write("> SignInManager\r\n@inject IdentityRedirectManager RedirectManager\r\n\r\n<PageTitle>Co" +
                    ...
                    "Code is null)\r\n        {\r\n            IdentityStatusMessage = \"Error: Invalid em" +
                    "ail change confirmation link.\";\r\n            RedirectManager.RedirectTo(\"Account" +
                    "/Login\");\r\n            return;\r\n        }\r\n\r\n        var user = await UserManage" +
                    "r.FindByIdAsync(UserId);\r\n        if (user is null)\r\n        {\r\n            mess" +
                    "age = $\"Error: Unable to find user with Id \'{UserId}\'\";\r\n            return;\r\n  " +
                    "      }\r\n\r\n        var code = Encoding.UTF8.GetString(WebEncoders.Base64UrlDecod" +
                    "e(Code));\r\n        var result = await UserManager.ChangeEmailAsync(user, Email, " +
                    "code);\r\n        if (!result.Succeeded)\r\n        {\r\n            message = \"Error " +
                    "changing email.\";\r\n            return;\r\n        }\r\n\r\n        // In our UI email " +
                    "and user name are one and the same, so when we update the email\r\n        // we n" +
                    "eed to update the user name.\r\n        var setUserNameResult = await UserManager." +
                    "SetUserNameAsync(user, Email);\r\n        if (!setUserNameResult.Succeeded)\r\n     " +
...
if ((ModelValueAcquired == false))
{
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "17.0.0.0")]
    public class ConfirmEmailChangeBase
    {
        #region Fields
