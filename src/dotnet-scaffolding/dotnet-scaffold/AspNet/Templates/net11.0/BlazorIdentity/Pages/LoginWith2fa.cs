...
if (!string.IsNullOrEmpty(Model.DbContextNamespace))
{
            ...
            this.Write("> UserManager\r\n@inject IdentityRedirectManager RedirectManager\r\n@inject ILogger<L" +
                    ...
                    "t @bind-Value=\"Input.TwoFactorCode\" id=\"Input.TwoFactorCode\" class=\"form-control" +
                    "\" autocomplete=\"off\" />\r\n                <label for=\"Input.TwoFactorCode\" class=" +
                    "\"form-label\">Authenticator code</label>\r\n                <ValidationMessage For=" +
                    "\"() => Input.TwoFactorCode\" class=\"text-danger\" />\r\n            </div>\r\n        " +
                    "    <div class=\"checkbox mb-3\">\r\n                <label class=\"form-label\">\r\n   " +
                    "                 <InputCheckbox @bind-Value=\"Input.RememberMachine\" />\r\n        " +
                    "            Remember this machine\r\n                </label>\r\n            </div>\r" +
                    "\n            <div>\r\n                <button type=\"submit\" class=\"w-100 btn btn-l" +
                    "g btn-primary\">Log in</button>\r\n            </div>\r\n        </EditForm>\r\n    </d" +
                    "iv>\r\n</div>\r\n<p>\r\n    Don\'t have access to your authenticator device? You can\r\n " +
                    "   <a href=\"Account/LoginWithRecoveryCode?ReturnUrl=@ReturnUrl\">log in with a re" +
