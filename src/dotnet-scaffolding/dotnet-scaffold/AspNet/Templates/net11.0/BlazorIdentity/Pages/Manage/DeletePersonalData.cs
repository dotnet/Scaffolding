...
namespace Microsoft.DotNet.Tools.Scaffold.AspNet.Templates.net11.BlazorIdentity.Pages.Manage
{
    ...
    public partial class DeletePersonalData : DeletePersonalDataBase
    {
        /// <summary>
        ...
        {
            this.Write("@page \"/Account/Manage/DeletePersonalData\"\r\n\r\n@using System.ComponentModel.DataAn" +
...
@code {
    ...
    private ");
            ...
            this.Write("? user;\r\n    private bool requirePassword;\r\n\r\n    [CascadingParameter]\r\n    priva" +
                    ...
                    "IdentityStatusMessage { get; set; }\r\n\r\n    [SupplyParameterFromForm]\r\n    privat" +
                    "e InputModel Input { get; set; } = default!;\r\n\r\n    protected override async Tas" +
                    ...
                    "return;\r\n        }\r\n        requirePassword = await UserManager.HasPasswordAsync" +
                    "(user);\r\n    }\r\n\r\n    private async Task OnValidSubmitAsync()\r\n    {\r\n        if" +
                    " (user is null)\r\n        {\r\n            RedirectManager.RedirectTo(\"Account/Inva" +
                    "lidUser\");\r\n            return;\r\n        }\r\n\r\n        if (requirePassword && !aw" +
                    "ait UserManager.CheckPasswordAsync(user, Input.Password))\r\n        {\r\n          " +
                    "  message = \"Error: Incorrect password.\";\r\n            return;\r\n        }\r\n\r\n   " +
                    "     var result = await UserManager.DeleteAsync(user);\r\n        if (!result.Succ" +
                    "eeded)\r\n        {\r\n            throw new InvalidOperationException(\"Unexpected e" +
                    "rror occurred deleting user.\");\r\n        }\r\n\r\n        await SignInManager.SignOu" +
...
if ((ModelValueAcquired == false))
{
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "17.0.0.0")]
    public class DeletePersonalDataBase
    {
        #region Fields
