...
@code {
    ...
    private ");
            ...
            this.Write("? user;\r\n\r\n    [CascadingParameter]\r\n    private HttpContext HttpContext { get; s" +
                    ...
                    "er = await UserManager.GetUserAsync(HttpContext.User);\r\n        if (user is null" +
                    ")\r\n        {\r\n            RedirectManager.RedirectTo(\"Account/InvalidUser\");\r\n  " +
                    "          return;\r\n        }\r\n\r\n        if (HttpMethods.IsGet(HttpContext.Reques" +
                    "t.Method) && !await UserManager.GetTwoFactorEnabledAsync(user))\r\n        {\r\n    " +
                    "        throw new InvalidOperationException(\"Cannot disable 2FA for user as it\'s" +
                    " not currently enabled.\");\r\n        }\r\n    }\r\n\r\n    private async Task OnSubmitA" +
                    "sync()\r\n    {\r\n        if (user is null)\r\n        {\r\n            RedirectManager" +
                    ".RedirectTo(\"Account/InvalidUser\");\r\n            return;\r\n        }\r\n\r\n        v" +
                    "ar disable2faResult = await UserManager.SetTwoFactorEnabledAsync(user, false);\r\n" +
                    "        if (!disable2faResult.Succeeded)\r\n        {\r\n            throw new Inval" +
                    "idOperationException(\"Unexpected error occurred disabling 2FA.\");\r\n        }\r\n\r\n" +
                    "        var userId = await UserManager.GetUserIdAsync(user);\r\n        Logger.Log" +
                    "Information(\"User with ID \'{UserId}\' has disabled 2fa.\", userId);\r\n        Ident" +
                    "ityStatusMessage = \"2fa has been disabled. You can reenable 2fa when you setup a" +
                    "n authenticator app\";\r\n        RedirectManager.RedirectTo(\"Account/Manage/TwoFac" +
                    "torAuthentication\");\r\n    }\r\n}\r\n");
