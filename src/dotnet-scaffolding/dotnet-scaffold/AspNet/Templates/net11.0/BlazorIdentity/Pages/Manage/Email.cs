...
if (!string.IsNullOrEmpty(Model.DbContextNamespace))
{
            ...
            this.Write("? user;\r\n    private string? email;\r\n    private bool isEmailConfirmed;\r\n\r\n    [C" +
                    ...
                    "arameterFromForm(FormName = \"change-email\")]\r\n    private InputModel Input { get" +
                    "; set; } = default!;\r\n\r\n    protected override async Task OnInitializedAsync()\r\n" +
                    "    {\r\n        message = IdentityStatusMessage;\r\n        IdentityStatusMessage =" +
                    " null;\r\n        Input ??= new();\r\n\r\n        user = await UserManager.GetUserAsyn" +
                    "c(HttpContext.User);\r\n        if (user is null)\r\n        {\r\n            Redirect" +
                    "Manager.RedirectTo(\"Account/InvalidUser\");\r\n            return;\r\n        }\r\n\r\n  " +
                    "      email = await UserManager.GetEmailAsync(user);\r\n        isEmailConfirmed =" +
                    " await UserManager.IsEmailConfirmedAsync(user);\r\n\r\n        Input.NewEmail ??= em" +
                    "ail;\r\n    }\r\n\r\n    private async Task OnValidSubmitAsync()\r\n    {\r\n        if (I" +
                    "nput.NewEmail is null || Input.NewEmail == email)\r\n        {\r\n            messag" +
                    "e = \"Your email is unchanged.\";\r\n            return;\r\n        }\r\n\r\n        if (u" +
                    "ser is null)\r\n        {\r\n            RedirectManager.RedirectTo(\"Account/Invalid" +
                    "User\");\r\n            return;\r\n        }\r\n\r\n        var userId = await UserManage" +
                    "r.GetUserIdAsync(user);\r\n        var code = await UserManager.GenerateChangeEmai" +
                    "lTokenAsync(user, Input.NewEmail);\r\n        code = WebEncoders.Base64UrlEncode(E" +
                    ...
                    "irmEmailChange\").AbsoluteUri,\r\n            new Dictionary<string, object?> { [\"u" +
                    "serId\"] = userId, [\"email\"] = Input.NewEmail, [\"code\"] = code });\r\n\r\n        awa" +
                    "it EmailSender.SendConfirmationLinkAsync(user, Input.NewEmail, HtmlEncoder.Defau" +
                    "lt.Encode(callbackUrl));\r\n\r\n        message = \"Confirmation link to change email" +
                    " sent. Please check your email.\";\r\n    }\r\n\r\n    private async Task OnSendEmailVe" +
                    "rificationAsync()\r\n    {\r\n        if (email is null)\r\n        {\r\n            ret" +
                    "urn;\r\n        }\r\n\r\n        if (user is null)\r\n        {\r\n            RedirectMan" +
                    "ager.RedirectTo(\"Account/InvalidUser\");\r\n            return;\r\n        }\r\n\r\n     " +
                    "   var userId = await UserManager.GetUserIdAsync(user);\r\n        var code = awai" +
                    "t UserManager.GenerateEmailConfirmationTokenAsync(user);\r\n        code = WebEnco" +
                    "ders.Base64UrlEncode(Encoding.UTF8.GetBytes(code));\r\n        var callbackUrl = N" +
                    "avigationManager.GetUriWithQueryParameters(\r\n            NavigationManager.ToAbs" +
                    "oluteUri(\"Account/ConfirmEmail\").AbsoluteUri,\r\n            new Dictionary<string" +
                    ", object?> { [\"userId\"] = userId, [\"code\"] = code });\r\n\r\n        await EmailSend" +
                    "er.SendConfirmationLinkAsync(user, email, HtmlEncoder.Default.Encode(callbackUrl" +
