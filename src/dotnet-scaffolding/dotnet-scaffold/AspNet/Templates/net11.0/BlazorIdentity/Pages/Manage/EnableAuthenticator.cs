...
if (!string.IsNullOrEmpty(Model.DbContextNamespace))
{
            ...
            this.Write("? user;\r\n    private string? sharedKey;\r\n    private string? authenticatorUri;\r\n " +
                    ...
                    "rFromTempData(Name = IdentityRedirectManager.StatusMessageKey)]\r\n    private str" +
                    "ing? IdentityStatusMessage { get; set; }\r\n\r\n    [SupplyParameterFromForm]\r\n    p" +
                    "rivate InputModel Input { get; set; } = default!;\r\n\r\n    protected override asyn" +
                    "c Task OnInitializedAsync()\r\n    {\r\n        message = IdentityStatusMessage;\r\n  " +
                    ...
                    "  var verificationCode = Input.Code.Replace(\" \", string.Empty).Replace(\"-\", stri" +
                    "ng.Empty);\r\n\r\n        var is2faTokenValid = await UserManager.VerifyTwoFactorTok" +
                    "enAsync(\r\n            user, UserManager.Options.Tokens.AuthenticatorTokenProvide" +
                    "r, verificationCode);\r\n\r\n        if (!is2faTokenValid)\r\n        {\r\n            m" +
                    "essage = \"Error: Verification code is invalid.\";\r\n            return;\r\n        }" +
                    "\r\n\r\n        await UserManager.SetTwoFactorEnabledAsync(user, true);\r\n        var" +
                    " userId = await UserManager.GetUserIdAsync(user);\r\n        Logger.LogInformation" +
                    "(\"User with ID \'{UserId}\' has enabled 2FA with an authenticator app.\", userId);\r" +
                    "\n\r\n        message = \"Your authenticator app has been verified.\";\r\n\r\n        if " +
                    "(await UserManager.CountRecoveryCodesAsync(user) == 0)\r\n        {\r\n            r" +
                    "ecoveryCodes = await UserManager.GenerateNewTwoFactorRecoveryCodesAsync(user, 10" +
                    ");\r\n        }\r\n        else\r\n        {\r\n            IdentityStatusMessage = mess" +
