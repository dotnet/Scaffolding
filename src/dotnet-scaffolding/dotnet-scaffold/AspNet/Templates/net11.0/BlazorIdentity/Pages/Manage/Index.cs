...
@code {
    ...
    private ");
            ...
            this.Write("? user;\r\n    private string? username;\r\n    private string? phoneNumber;\r\n\r\n    [" +
                    ...
                    "dentityStatusMessage;\r\n        IdentityStatusMessage = null;\r\n        Input ??= " +
                    "new();\r\n\r\n        user = await UserManager.GetUserAsync(HttpContext.User);\r\n    " +
                    "    if (user is null)\r\n        {\r\n            RedirectManager.RedirectTo(\"Accoun" +
                    "t/InvalidUser\");\r\n            return;\r\n        }\r\n\r\n        username = await Use" +
                    "rManager.GetUserNameAsync(user);\r\n        phoneNumber = await UserManager.GetPho" +
                    "neNumberAsync(user);\r\n\r\n        Input.PhoneNumber ??= phoneNumber;\r\n    }\r\n\r\n   " +
                    " private async Task OnValidSubmitAsync()\r\n    {\r\n        if (user is null)\r\n    " +
                    "    {\r\n            RedirectManager.RedirectTo(\"Account/InvalidUser\");\r\n         " +
                    "   return;\r\n        }\r\n\r\n        if (Input.PhoneNumber != phoneNumber)\r\n        " +
                    "{\r\n            var setPhoneResult = await UserManager.SetPhoneNumberAsync(user, " +
                    "Input.PhoneNumber);\r\n            if (!setPhoneResult.Succeeded)\r\n            {\r\n" +
                    "                IdentityStatusMessage = \"Error: Failed to set phone number.\";\r\n " +
                    "               RedirectManager.RedirectToCurrentPage();\r\n                return;" +
                    "\r\n            }\r\n        }\r\n\r\n        await SignInManager.RefreshSignInAsync(use" +
