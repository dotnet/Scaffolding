...
@code {
    private ");
            ...
            this.Write("? user;\r\n    private UserPasskeyInfo? passkey;\r\n\r\n    [CascadingParameter]\r\n    p" +
                    ...
                    "ng? IdentityStatusMessage { get; set; }\r\n\r\n    [Parameter]\r\n    public string? I" +
                    ...
                    "sage = \"Error: The specified passkey ID had an invalid format.\";\r\n            Re" +
                    "directManager.RedirectTo(\"Account/Manage/Passkeys\");\r\n            return;\r\n     " +
                    ...
                    "RedirectTo(\"Account/Manage/Passkeys\");\r\n            return;\r\n        }\r\n    }\r\n\r" +
                    "\n    private async Task Rename()\r\n    {\r\n        passkey!.Name = Input.Name;\r\n  " +
                    "      var result = await UserManager.AddOrUpdatePasskeyAsync(user!, passkey);\r\n " +
                    "       if (!result.Succeeded)\r\n        {\r\n            IdentityStatusMessage = \"E" +
                    "rror: The passkey could not be updated.\";\r\n            RedirectManager.RedirectT" +
                    "o(\"Account/Manage/Passkeys\");\r\n            return;\r\n        }\r\n\r\n        Identit" +
                    "yStatusMessage = \"Passkey updated successfully.\";\r\n        RedirectManager.Redir" +
                    "ectTo(\"Account/Manage/Passkeys\");\r\n    }\r\n\r\n    private sealed class InputModel\r" +
                    "\n    {\r\n        [Required]\r\n        [StringLength(200, ErrorMessage = \"Passkey n" +
                    "ames must be no longer than {1} characters.\")]\r\n        public string Name { get" +
                    "; set; } = \"\";\r\n    }\r\n}\r\n");
