...
namespace Microsoft.DotNet.Tools.Scaffold.AspNet.Templates.net11.BlazorIdentity.Pages.Manage
{
    ...
    public partial class ResetAuthenticator : ResetAuthenticatorBase
    {
        /// <summary>
        ...
        {
            this.Write("@page \"/Account/Manage/ResetAuthenticator\"\r\n\r\n@using Microsoft.AspNetCore.Identit" +
                    "y\r\n");
...
if (!string.IsNullOrEmpty(Model.DbContextNamespace))
{
            ...
            this.Write("> SignInManager\r\n@inject IdentityRedirectManager RedirectManager\r\n@inject ILogger" +
                    ...
                    "ass=\"alert alert-warning\" role=\"alert\">\r\n    <p>\r\n        <span class=\"glyphicon" +
                    " glyphicon-warning-sign\"></span>\r\n        <strong>If you reset your authenticato" +
                    "r key your authenticator app will not work until you reconfigure it.</strong>\r\n " +
                    "   </p>\r\n    <p>\r\n        This process disables 2FA until you verify your authen" +
                    "ticator app.\r\n        If you do not complete your authenticator app configuratio" +
                    "n you may lose access to your account.\r\n    </p>\r\n</div>\r\n<div>\r\n    <form @form" +
                    "name=\"reset-authenticator\" @onsubmit=\"OnSubmitAsync\" method=\"post\">\r\n        <bu" +
                    "tton class=\"btn btn-danger\" type=\"submit\">Reset authenticator key</button>\r\n    " +
                    "</form>\r\n</div>\r\n\r\n@code {\r\n    private string? message;\r\n\r\n    [CascadingParame" +
                    "ter]\r\n    private HttpContext HttpContext { get; set; } = default!;\r\n\r\n    [Supp" +
                    "lyParameterFromTempData(Name = IdentityRedirectManager.StatusMessageKey)]\r\n    p" +
                    "rivate string? IdentityStatusMessage { get; set; }\r\n\r\n    protected override voi" +
                    "d OnInitialized()\r\n    {\r\n        message = IdentityStatusMessage;\r\n        Iden" +
                    "tityStatusMessage = null;\r\n    }\r\n\r\n    private async Task OnSubmitAsync()\r\n    " +
                    "{\r\n        var user = await UserManager.GetUserAsync(HttpContext.User);\r\n       " +
                    " if (user is null)\r\n        {\r\n            RedirectManager.RedirectTo(\"Account/I" +
                    "nvalidUser\");\r\n            return;\r\n        }\r\n\r\n        await UserManager.SetTw" +
                    "oFactorEnabledAsync(user, false);\r\n        await UserManager.ResetAuthenticatorK" +
                    "eyAsync(user);\r\n        var userId = await UserManager.GetUserIdAsync(user);\r\n  " +
                    "      Logger.LogInformation(\"User with ID \'{UserId}\' has reset their authenticat" +
                    "ion app key.\", userId);\r\n\r\n        await SignInManager.RefreshSignInAsync(user);" +
                    "\r\n\r\n        IdentityStatusMessage = \"Your authenticator app key has been reset, " +
...
if ((ModelValueAcquired == false))
{
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "17.0.0.0")]
    public class ResetAuthenticatorBase
    {
        #region Fields
