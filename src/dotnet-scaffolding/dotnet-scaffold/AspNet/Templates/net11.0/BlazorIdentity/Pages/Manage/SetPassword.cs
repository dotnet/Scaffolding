...
if (!string.IsNullOrEmpty(Model.DbContextNamespace))
{
            ...
            this.Write("? user;\r\n\r\n    [CascadingParameter]\r\n    private HttpContext HttpContext { get; s" +
                    ...
                    "     Input ??= new();\r\n\r\n        user = await UserManager.GetUserAsync(HttpConte" +
                    "xt.User);\r\n        if (user is null)\r\n        {\r\n            RedirectManager.Red" +
                    "irectTo(\"Account/InvalidUser\");\r\n            return;\r\n        }\r\n\r\n        var h" +
                    "asPassword = await UserManager.HasPasswordAsync(user);\r\n        if (hasPassword)" +
                    "\r\n        {\r\n            RedirectManager.RedirectTo(\"Account/Manage/ChangePasswo" +
                    "rd\");\r\n        }\r\n    }\r\n\r\n    private async Task OnValidSubmitAsync()\r\n    {\r\n " +
                    "       if (user is null)\r\n        {\r\n            RedirectManager.RedirectTo(\"Acc" +
                    "ount/InvalidUser\");\r\n            return;\r\n        }\r\n\r\n        var addPasswordRe" +
                    "sult = await UserManager.AddPasswordAsync(user, Input.NewPassword!);\r\n        if" +
                    " (!addPasswordResult.Succeeded)\r\n        {\r\n            message = $\"Error: {stri" +
                    "ng.Join(\",\", addPasswordResult.Errors.Select(error => error.Description))}\";\r\n  " +
                    "          return;\r\n        }\r\n\r\n        await SignInManager.RefreshSignInAsync(u" +
                    "ser);\r\n        IdentityStatusMessage = \"Your password has been set.\";\r\n        R" +
                    "edirectManager.RedirectToCurrentPage();\r\n    }\r\n\r\n    private sealed class Input" +
