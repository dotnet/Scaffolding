...
if (!string.IsNullOrEmpty(Model.DbContextNamespace))
{
            ...
            this.Write("> SignInManager\r\n@inject IdentityRedirectManager RedirectManager\r\n\r\n<PageTitle>Tw" +
                    ...
                    "lass=\"alert alert-danger\">\r\n                <strong>You have no recovery codes l" +
                    "eft.</strong>\r\n                <p>You must <a href=\"Account/Manage/GenerateRecov" +
                    "eryCodes\">generate a new set of recovery codes</a> before you can log in with a " +
                    "recovery code.</p>\r\n            </div>\r\n        }\r\n        else if (recoveryCode" +
                    "sLeft == 1)\r\n        {\r\n            <div class=\"alert alert-danger\">\r\n          " +
                    "      <strong>You have 1 recovery code left.</strong>\r\n                <p>You ca" +
                    "n <a href=\"Account/Manage/GenerateRecoveryCodes\">generate a new set of recovery " +
                    "codes</a>.</p>\r\n            </div>\r\n        }\r\n        else if (recoveryCodesLef" +
                    "t <= 3)\r\n        {\r\n            <div class=\"alert alert-warning\">\r\n             " +
                    "   <strong>You have @recoveryCodesLeft recovery codes left.</strong>\r\n          " +
                    "      <p>You should <a href=\"Account/Manage/GenerateRecoveryCodes\">generate a ne" +
                    "w set of recovery codes</a>.</p>\r\n            </div>\r\n        }\r\n\r\n        if (i" +
                    "sMachineRemembered)\r\n        {\r\n            <form style=\"display: inline-block\" " +
                    "@formname=\"forget-browser\" @onsubmit=\"OnSubmitForgetBrowserAsync\" method=\"post\">" +
                    "\r\n                <button type=\"submit\" class=\"btn btn-primary\">Forget this brow" +
                    "ser</button>\r\n            </form>\r\n        }\r\n\r\n        <a href=\"Account/Manage/" +
                    "Disable2fa\" class=\"btn btn-primary\">Disable 2FA</a>\r\n        <a href=\"Account/Ma" +
                    "nage/GenerateRecoveryCodes\" class=\"btn btn-primary\">Reset recovery codes</a>\r\n  " +
                    "  }\r\n\r\n    <h4>Authenticator app</h4>\r\n    @if (!hasAuthenticator)\r\n    {\r\n     " +
                    "   <a href=\"Account/Manage/EnableAuthenticator\" class=\"btn btn-primary\">Add auth" +
                    "enticator app</a>\r\n    }\r\n    else\r\n    {\r\n        <a href=\"Account/Manage/Enabl" +
                    "eAuthenticator\" class=\"btn btn-primary\">Set up authenticator app</a>\r\n        <a" +
                    " href=\"Account/Manage/ResetAuthenticator\" class=\"btn btn-primary\">Reset authenti" +
                    "cator app</a>\r\n    }\r\n}\r\nelse\r\n{\r\n    <div class=\"alert alert-danger\">\r\n        " +
                    "<strong>Privacy and cookie policy have not been accepted.</strong>\r\n        <p>Y" +
                    "ou must accept the policy before you can enable two factor authentication.</p>\r\n" +
                    "    </div>\r\n}\r\n\r\n@code {\r\n    private string? message;\r\n    private bool canTrac" +
                    ...
                    "rride async Task OnInitializedAsync()\r\n    {\r\n        message = IdentityStatusMe" +
                    "ssage;\r\n        IdentityStatusMessage = null;\r\n\r\n        var user = await UserMa" +
                    "nager.GetUserAsync(HttpContext.User);\r\n        if (user is null)\r\n        {\r\n   " +
                    "         RedirectManager.RedirectTo(\"Account/InvalidUser\");\r\n            return;" +
                    "\r\n        }\r\n\r\n        canTrack = HttpContext.Features.Get<ITrackingConsentFeatu" +
                    "re>()?.CanTrack ?? true;\r\n        hasAuthenticator = await UserManager.GetAuthen" +
                    "ticatorKeyAsync(user) is not null;\r\n        is2faEnabled = await UserManager.Get" +
                    "TwoFactorEnabledAsync(user);\r\n        isMachineRemembered = await SignInManager." +
                    "IsTwoFactorClientRememberedAsync(user);\r\n        recoveryCodesLeft = await UserM" +
                    "anager.CountRecoveryCodesAsync(user);\r\n    }\r\n\r\n    private async Task OnSubmitF" +
                    "orgetBrowserAsync()\r\n    {\r\n        await SignInManager.ForgetTwoFactorClientAsy" +
                    "nc();\r\n\r\n        IdentityStatusMessage = \"The current browser has been forgotten" +
