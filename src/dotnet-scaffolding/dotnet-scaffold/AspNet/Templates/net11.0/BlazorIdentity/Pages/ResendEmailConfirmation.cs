...
if (!string.IsNullOrEmpty(Model.DbContextNamespace))
{
            ...
            this.Write("> EmailSender\r\n@inject NavigationManager NavigationManager\r\n@inject IdentityRedir" +
                    ...
                    "ummary class=\"text-danger\" />\r\n            </div>\n            <div class=\"form-f" +
                    "loating mb-3\">\r\n                <InputText @bind-Value=\"Input.Email\" id=\"Input.E" +
                    "mail\" class=\"form-control\" aria-required=\"true\" placeholder=\"name@example.com\" /" +
                    ">\r\n                <label for=\"Input.Email\" class=\"form-label\">Email</label>\r\n  " +
                    "              <ValidationMessage For=\"() => Input.Email\" class=\"text-danger\" />\r" +
                    "\n            </div>\r\n            <button type=\"submit\" class=\"w-100 btn btn-lg b" +
                    "tn-primary\">Resend</button>\r\n        </EditForm>\r\n    </div>\r\n</div>\r\n\r\n@code {\r" +
                    "\n    private string? message;\r\n\r\n    [SupplyParameterFromForm]\r\n    private Inpu" +
                    "tModel Input { get; set; } = default!;\r\n\r\n    protected override void OnInitiali" +
                    "zed()\r\n    {\r\n        Input ??= new();\r\n    }\r\n\r\n    private async Task OnValidS" +
                    "ubmitAsync()\r\n    {\r\n        var user = await UserManager.FindByEmailAsync(Input" +
                    ".Email!);\r\n        if (user is null)\r\n        {\r\n            message = \"Verifica" +
                    "tion email sent. Please check your email.\";\r\n            return;\r\n        }\r\n\r\n " +
                    "       var userId = await UserManager.GetUserIdAsync(user);\r\n        var code = " +
                    "await UserManager.GenerateEmailConfirmationTokenAsync(user);\r\n        code = Web" +
                    "Encoders.Base64UrlEncode(Encoding.UTF8.GetBytes(code));\r\n        var callbackUrl" +
                    " = NavigationManager.GetUriWithQueryParameters(\r\n            NavigationManager.T" +
                    "oAbsoluteUri(\"Account/ConfirmEmail\").AbsoluteUri,\r\n            new Dictionary<st" +
                    "ring, object?> { [\"userId\"] = userId, [\"code\"] = code });\r\n        await EmailSe" +
                    "nder.SendConfirmationLinkAsync(user, Input.Email, HtmlEncoder.Default.Encode(cal" +
                    "lbackUrl));\r\n\r\n        message = \"Verification email sent. Please check your ema" +
