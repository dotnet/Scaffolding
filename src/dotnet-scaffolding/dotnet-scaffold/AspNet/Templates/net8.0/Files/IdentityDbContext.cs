...
private global::Microsoft.DotNet.Tools.Scaffold.AspNet.Templates.net8.Files.IdentityDbContextModel _ModelField;

/// <summary>
/// Access the Model parameter of the template.
/// </summary>
private global::Microsoft.DotNet.Tools.Scaffold.AspNet.Templates.net8.Files.IdentityDbContextModel Model
{
    get
    {
...
{
    this._ModelField = ((global::Microsoft.DotNet.Tools.Scaffold.AspNet.Templates.net8.Files.IdentityDbContextModel)(this.Session["Model"]));
...
if ((ModelValueAcquired == false))
{
    ...
    {
        global::System.ComponentModel.TypeConverter tc = global::System.ComponentModel.TypeDescriptor.GetConverter(typeof(global::Microsoft.DotNet.Tools.Scaffold.AspNet.Templates.net8.Files.IdentityDbContextModel));
        if (((tc != null) 
                    && tc.CanConvertFrom(typeof(string))))
        {
            this._ModelField = ((global::Microsoft.DotNet.Tools.Scaffold.AspNet.Templates.net8.Files.IdentityDbContextModel)(tc.ConvertFrom(parameterValue)));
            ModelValueAcquired = true;
        }
        else
        {
...
if ((ModelValueAcquired == false))
{
    ...
    if ((data != null))
    {
        this._ModelField = ((global::Microsoft.DotNet.Tools.Scaffold.AspNet.Templates.net8.Files.IdentityDbContextModel)(data));
    }
}
