 ...
 *
 * Usage examples:
 *  currency: ["┬ú", false] - Use false for soft currency validation
 *  currency: ["$", false]
 ...
 * @Description Brazillian PIS or NIS number (N├║mero de Identifica├º├úo Social Pis ou Pasep) is the equivalent of a
 * Brazilian tax registration number NIS of PIS numbers have 11 digits in total: 10 numbers followed by 1 check numbers
 * that are being used for validation.
 * @copyright (c) 21/08/2018 13:14, Cleiton da Silva Mendon├ºa
 * @author Cleiton da Silva Mendon├ºa <cleiton.mendonca@gmail.com>
 * @link http://gitlab.com/csmendonca Gitlab of Cleiton da Silva Mendon├ºa
 * @link http://github.com/csmendonca Github of Cleiton da Silva Mendon├ºa
 */
