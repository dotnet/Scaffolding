...
namespace Microsoft.DotNet.Tools.Scaffold.AspNet.Templates.net9.Identity.Pages.Account
{
    ...
    public partial class LoginWith2fa : LoginWith2faBase
    {
        ...
        {
            this.Write("@page\r\n@model LoginWith2faModel\r\n@{\r\n    ViewData[\"Title\"] = \"Two-factor authenti" +
                    "cation\";\r\n}\r\n\r\n<h1>@ViewData[\"Title\"]</h1>\r\n<hr />\r\n<p>Your login is protected w" +
                    "ith an authenticator app. Enter your authenticator code below.</p>\r\n<div class=\"" +
                    "row\">\r\n    <div class=\"col-md-4\">\r\n        <form method=\"post\" asp-route-returnU" +
                    "rl=\"@Model.ReturnUrl\">\r\n            <input asp-for=\"RememberMe\" type=\"hidden\" />" +
                    "\r\n            <div asp-validation-summary=\"ModelOnly\" class=\"text-danger\" role=\"" +
                    "alert\"></div>\r\n            <div class=\"form-floating mb-3\">\r\n                <in" +
                    "put asp-for=\"Input.TwoFactorCode\" class=\"form-control\" autocomplete=\"off\" />\r\n  " +
                    "              <label asp-for=\"Input.TwoFactorCode\" class=\"form-label\"></label>\r\n" +
                    "                <span asp-validation-for=\"Input.TwoFactorCode\" class=\"text-dange" +
                    "r\"></span>\r\n            </div>\r\n            <div class=\"checkbox mb-3\">\r\n       " +
                    "         <label asp-for=\"Input.RememberMachine\" class=\"form-label\">\r\n           " +
                    "         <input asp-for=\"Input.RememberMachine\" />\r\n                    @Html.Di" +
                    "splayNameFor(m => m.Input.RememberMachine)\r\n                </label>\r\n          " +
                    "  </div>\r\n            <div>\r\n                <button type=\"submit\" class=\"w-100 " +
                    "btn btn-lg btn-primary\">Log in</button>\r\n            </div>\r\n        </form>\r\n  " +
                    "  </div>\r\n</div>\r\n<p>\r\n    Don\'t have access to your authenticator device? You c" +
                    "an\r\n    <a id=\"recovery-code-login\" asp-page=\"./LoginWithRecoveryCode\" asp-route" +
                    "-returnUrl=\"@Model.ReturnUrl\">log in with a recovery code</a>.\r\n</p>\r\n\r\n@section" +
