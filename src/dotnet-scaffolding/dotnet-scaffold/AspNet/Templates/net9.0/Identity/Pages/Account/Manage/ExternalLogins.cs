    ...
    public partial class ExternalLogins : ExternalLoginsBase
    {
        ...
        public virtual string TransformText()
        {
            ...
            this.Write("@page\r\n@model ExternalLoginsModel\r\n@{\r\n    ViewData[\"Title\"] = \"Manage your exter" +
                    ...
                    " {\r\n                <tr>\r\n                    <td id=\"@($\"login-provider-{login." +
                    "LoginProvider}\")\">@login.ProviderDisplayName</td>\r\n                    <td>\r\n   " +
                    "                     @if (Model.ShowRemoveButton)\r\n                        {\r\n  " +
                    "                          <form id=\"@($\"remove-login-{login.LoginProvider}\")\" as" +
                    "p-page-handler=\"RemoveLogin\" method=\"post\">\r\n                                <di" +
                    "v>\r\n                                    <input asp-for=\"@login.LoginProvider\" na" +
                    "me=\"LoginProvider\" type=\"hidden\" />\r\n                                    <input " +
                    "asp-for=\"@login.ProviderKey\" name=\"ProviderKey\" type=\"hidden\" />\r\n              " +
                    "                      <button type=\"submit\" class=\"btn btn-primary\" title=\"Remov" +
                    "e this @login.ProviderDisplayName login from your account\">Remove</button>\r\n    " +
                    "                            </div>\r\n                            </form>\r\n       " +
                    "                 }\r\n                        else\r\n                        {\r\n   " +
                    "                         @: &nbsp;\r\n                        }\r\n                 " +
                    "   </td>\r\n                </tr>\r\n            }\r\n        </tbody>\r\n    </table>\r\n" +
                    "}\r\n@if (Model.OtherLogins?.Count > 0)\r\n{\r\n    <h4>Add another service to log in." +
                    "</h4>\r\n    <hr />\r\n    <form id=\"link-login-form\" asp-page-handler=\"LinkLogin\" m" +
                    "ethod=\"post\" class=\"form-horizontal\">\r\n        <div id=\"socialLoginList\">\r\n     " +
                    "       <p>\r\n                @foreach (var provider in Model.OtherLogins)\r\n      " +
                    "          {\r\n                    <button id=\"@($\"link-login-button-{provider.Nam" +
                    "e}\")\" type=\"submit\" class=\"btn btn-primary\" name=\"provider\" value=\"@provider.Nam" +
                    "e\" title=\"Log in using your @provider.DisplayName account\">@provider.DisplayName" +
                    "</button>\r\n                }\r\n            </p>\r\n        </div>\r\n    </form>\r\n}\r\n" +
                    "");
