...
using ");
            ...
            this.Write(" user)\r\n    {\r\n        var userName = await _userManager.GetUserNameAsync(user);\r" +
                    ...
                    "k<IActionResult> OnPostAsync()\r\n    {\r\n        var user = await _userManager.Get" +
                    "UserAsync(User);\r\n        if (user == null)\r\n        {\r\n            return NotFo" +
                    "und($\"Unable to load user with ID \'{_userManager.GetUserId(User)}\'.\");\r\n        " +
                    "}\r\n\r\n        if (!ModelState.IsValid)\r\n        {\r\n            await LoadAsync(us" +
                    "er);\r\n            return Page();\r\n        }\r\n\r\n        var phoneNumber = await _" +
                    "userManager.GetPhoneNumberAsync(user);\r\n        if (Input.PhoneNumber != phoneNu" +
                    "mber)\r\n        {\r\n            var setPhoneResult = await _userManager.SetPhoneNu" +
                    "mberAsync(user, Input.PhoneNumber);\r\n            if (!setPhoneResult.Succeeded)\r" +
                    "\n            {\r\n                StatusMessage = \"Unexpected error when trying to" +
                    " set phone number.\";\r\n                return RedirectToPage();\r\n            }\r\n " +
                    "       }\r\n\r\n        await _signInManager.RefreshSignInAsync(user);\r\n        Stat" +
                    "usMessage = \"Your profile has been updated\";\r\n        return RedirectToPage();\r\n" +
                    "    }\r\n}\r\n");
