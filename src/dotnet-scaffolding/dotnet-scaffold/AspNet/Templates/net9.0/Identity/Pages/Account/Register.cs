    ...
    public partial class Register : RegisterBase
    {
        ...
        public virtual string TransformText()
        {
            this.Write("@page\r\n@model RegisterModel\r\n@{\r\n    ViewData[\"Title\"] = \"Register\";\r\n}\r\n\r\n<h1>@V" +
                    ...
                    "Email\" class=\"form-control\" autocomplete=\"username\" aria-required=\"true\" placeho" +
                    "lder=\"name@example.com\" />\r\n                <label asp-for=\"Input.Email\">Email</" +
                    "label>\r\n                <span asp-validation-for=\"Input.Email\" class=\"text-dange" +
                    "r\"></span>\r\n            </div>\r\n            <div class=\"form-floating mb-3\">\r\n  " +
                    "              <input asp-for=\"Input.Password\" class=\"form-control\" autocomplete=" +
                    "\"new-password\" aria-required=\"true\" placeholder=\"password\" />\r\n                <" +
                    "label asp-for=\"Input.Password\">Password</label>\r\n                <span asp-valid" +
                    "ation-for=\"Input.Password\" class=\"text-danger\"></span>\r\n            </div>\r\n    " +
                    "        <div class=\"form-floating mb-3\">\r\n                <input asp-for=\"Input." +
                    "ConfirmPassword\" class=\"form-control\" autocomplete=\"new-password\" aria-required=" +
                    "\"true\" placeholder=\"password\" />\r\n                <label asp-for=\"Input.ConfirmP" +
                    ...
                    "ion services configured. See this <a href=\"https://go.microsoft.com/fwlink/?Link" +
                    "ID=532715\">article\r\n                            about setting up this ASP.NET ap" +
                    "plication to support logging in via external services</a>.\r\n                    " +
                    "    </p>\r\n                    </div>\r\n                }\r\n                else\r\n " +
                    "               {\r\n                    <form id=\"external-account\" asp-page=\"./Ex" +
                    "ternalLogin\" asp-route-returnUrl=\"@Model.ReturnUrl\" method=\"post\" class=\"form-ho" +
                    "rizontal\">\r\n                        <div>\r\n                            <p>\r\n    " +
                    "                            @foreach (var provider in Model.ExternalLogins!)\r\n  " +
                    "                              {\r\n                                    <button typ" +
                    "e=\"submit\" class=\"btn btn-primary\" name=\"provider\" value=\"@provider.Name\" title=" +
                    "\"Log in using your @provider.DisplayName account\">@provider.DisplayName</button>" +
                    "\r\n                                }\r\n                            </p>\r\n         " +
                    "               </div>\r\n                    </form>\r\n                }\r\n         " +
                    "   }\r\n        </section>\r\n    </div>\r\n</div>\r\n\r\n@section Scripts {\r\n    <partial" +
