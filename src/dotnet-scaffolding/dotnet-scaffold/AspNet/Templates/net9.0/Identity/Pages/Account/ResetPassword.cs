    ...
    public partial class ResetPassword : ResetPasswordBase
    {
        ...
        public virtual string TransformText()
        {
            this.Write("@page\r\n@model ResetPasswordModel\r\n@{\r\n    ViewData[\"Title\"] = \"Reset password\";\r\n" +
                    ...
                    "ass=\"form-floating mb-3\">\r\n                <input asp-for=\"Input.Email\" class=\"f" +
                    "orm-control\" autocomplete=\"username\" aria-required=\"true\" placeholder=\"name@exam" +
                    "ple.com\" />\r\n                <label asp-for=\"Input.Email\" class=\"form-label\"></l" +
                    "abel>\r\n                <span asp-validation-for=\"Input.Email\" class=\"text-danger" +
                    "\"></span>\r\n            </div>\r\n            <div class=\"form-floating mb-3\">\r\n   " +
                    "             <input asp-for=\"Input.Password\" class=\"form-control\" autocomplete=\"" +
                    "new-password\" aria-required=\"true\" placeholder=\"Please enter your password.\" />\r" +
                    "\n                <label asp-for=\"Input.Password\" class=\"form-label\"></label>\r\n  " +
                    "              <span asp-validation-for=\"Input.Password\" class=\"text-danger\"></sp" +
                    "an>\r\n            </div>\r\n            <div class=\"form-floating mb-3\">\r\n         " +
                    "       <input asp-for=\"Input.ConfirmPassword\" class=\"form-control\" autocomplete=" +
                    "\"new-password\" aria-required=\"true\" placeholder=\"Please confirm your password.\" " +
                    "/>\r\n                <label asp-for=\"Input.ConfirmPassword\" class=\"form-label\"></" +
                    "label>\r\n                <span asp-validation-for=\"Input.ConfirmPassword\" class=\"" +
                    "text-danger\"></span>\r\n            </div>\r\n            <button type=\"submit\" clas" +
                    "s=\"w-100 btn btn-lg btn-primary\">Reset</button>\r\n        </form>\r\n    </div>\r\n</" +
