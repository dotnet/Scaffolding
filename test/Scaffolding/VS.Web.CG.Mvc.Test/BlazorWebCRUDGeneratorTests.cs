    ...
    public class BlazorWebCRUDGeneratorTests
    {
        ...
        public void ValidateAndGetOutputPathTests()
        {
            ...
            if (isWindows)
            {
                ...
                Assert.Equal(@"AppPath\Components\Pages\testModelPages\NotFound.razor", blazorGenerator.ValidateAndGetOutputPath("testModel", "NotFound"));
                Assert.Equal(@"AppPath\SpecialPages\BlazorComponents\testModelPages\NotFound.razor", blazorGenerator.ValidateAndGetOutputPath("testModel", "NotFound", relativeFolderPath));
            }
            else
            {
                ...
                Assert.Equal(@"AppPath/Components/Pages/testModelPages/NotFound.razor", blazorGenerator.ValidateAndGetOutputPath("testModel", "NotFound"));
                Assert.Equal(@"AppPath/SpecialPages/BlazorComponents/testModelPages/NotFound.razor", blazorGenerator.ValidateAndGetOutputPath("testModel", "NotFound", relativeFolderPath));
            }
        }
