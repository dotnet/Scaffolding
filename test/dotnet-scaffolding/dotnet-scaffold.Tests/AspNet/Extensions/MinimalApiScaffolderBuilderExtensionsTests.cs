...
public class MinimalApiScaffolderBuilderExtensionsTests
{
    [Fact]
    public void WithMinimalApiCodeChangeStep_ReturnsBuilder()
    {
        // Arrange
        ...
        // Act
        IScaffoldBuilder result = mockBuilder.Object.WithMinimalApiCodeChangeStep();
    ...
    [Fact]
    public void WithMinimalApiAddPackagesStep_ReturnsBuilder()
    {
        // Arrange
        Mock<IScaffoldBuilder> mockBuilder = new Mock<IScaffoldBuilder>();
        ...
        // Act
        IScaffoldBuilder result = mockBuilder.Object.WithMinimalApiAddPackagesStep();
    ...
    [Fact]
    public void WithMinimalApiTextTemplatingStep_ReturnsBuilder()
    {
        // Arrange
        Mock<IScaffoldBuilder> mockBuilder = new Mock<IScaffoldBuilder>();
        ...
        // Act
        IScaffoldBuilder result = mockBuilder.Object.WithMinimalApiTextTemplatingStep();
