...
public class RazorPagesScaffolderBuilderExtensionsTests
{
    [Fact]
    public void WithRazorPagesCodeChangeStep_ReturnsBuilder()
    {
        // Arrange
        ...
        // Act
        IScaffoldBuilder result = mockBuilder.Object.WithRazorPagesCodeChangeStep();
    ...
    [Fact]
    public void WithRazorPagesTextTemplatingStep_ReturnsBuilder()
    {
        // Arrange
        Mock<IScaffoldBuilder> mockBuilder = new Mock<IScaffoldBuilder>();
        ...
        // Act
        IScaffoldBuilder result = mockBuilder.Object.WithRazorPagesTextTemplatingStep();
    ...
    [Fact]
    public void WithRazorPagesAddPackagesStep_ReturnsBuilder()
    {
        // Arrange
        Mock<IScaffoldBuilder> mockBuilder = new Mock<IScaffoldBuilder>();
        ...
        // Act
        IScaffoldBuilder result = mockBuilder.Object.WithRazorPagesAddPackagesStep();
