...
public class MinimalApiNet11IntegrationTests : MinimalApiIntegrationTestsBase
{
    ...
    [Fact]
    public async Task Scaffold_MinimalApi_Net11_BuildsAndValidates()
    {
        // Arrange
        ...
        // Scaffold  use ValidateMinimalApiStep with real FileSystem (returns false since model class doesn't exist)
        ...
        step.Endpoints = "TestModelEndpoints";
