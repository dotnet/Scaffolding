...
public abstract class BlazorCrudIntegrationTestsBase : IDisposable
{
    ...
    /// <summary>
    /// Parses the string TargetFramework (e.g. "net11.0") to the <see cref="Microsoft.DotNet.Scaffolding.Core.Model.TargetFramework"/> enum.
    /// </summary>
    protected TargetFramework? ParsedTargetFramework =>
        TargetFramework switch
        {
            "net8.0" => Microsoft.DotNet.Scaffolding.Core.Model.TargetFramework.Net8,
            "net9.0" => Microsoft.DotNet.Scaffolding.Core.Model.TargetFramework.Net9,
            "net10.0" => Microsoft.DotNet.Scaffolding.Core.Model.TargetFramework.Net10,
            "net11.0" => Microsoft.DotNet.Scaffolding.Core.Model.TargetFramework.Net11,
            _ => null
        };
  ...
  <PropertyGroup>
    ...
    {
        Assert.NotNull(BlazorCrudHelper.GetTemplateType(BlazorCrudHelper.CreateBlazorTemplate, ParsedTargetFramework));
    }

    [Fact]
    public void GetTemplateType_WithDeleteTemplate_ReturnsNonNull()
    {
        Assert.NotNull(BlazorCrudHelper.GetTemplateType(BlazorCrudHelper.DeleteBlazorTemplate, ParsedTargetFramework));
    }

    [Fact]
    public void GetTemplateType_WithDetailsTemplate_ReturnsNonNull()
    {
        Assert.NotNull(BlazorCrudHelper.GetTemplateType(BlazorCrudHelper.DetailsBlazorTemplate, ParsedTargetFramework));
    }

    [Fact]
    public void GetTemplateType_WithEditTemplate_ReturnsNonNull()
    {
        Assert.NotNull(BlazorCrudHelper.GetTemplateType(BlazorCrudHelper.EditBlazorTemplate, ParsedTargetFramework));
    }

    [Fact]
    public void GetTemplateType_WithIndexTemplate_ReturnsNonNull()
    {
        Assert.NotNull(BlazorCrudHelper.GetTemplateType(BlazorCrudHelper.IndexBlazorTemplate, ParsedTargetFramework));
    }

    [Fact]
    public void GetTemplateType_WithNotFoundTemplate_ReturnsExpectedResult()
    {
        var result = BlazorCrudHelper.GetTemplateType(BlazorCrudHelper.NotFoundBlazorTemplate, ParsedTargetFramework);

        // NotFound template is only available for Net10+
        if (ParsedTargetFramework is Microsoft.DotNet.Scaffolding.Core.Model.TargetFramework.Net10
            or Microsoft.DotNet.Scaffolding.Core.Model.TargetFramework.Net11)
        {
    ...
    {
        Assert.Null(BlazorCrudHelper.GetTemplateType(null, ParsedTargetFramework));
    }

    [Fact]
    public void GetTemplateType_WithEmpty_ReturnsNull()
    {
        Assert.Null(BlazorCrudHelper.GetTemplateType(string.Empty, ParsedTargetFramework));
    }

    [Fact]
    public void GetTemplateType_WithUnknownTemplate_ReturnsNull()
    {
        Assert.Null(BlazorCrudHelper.GetTemplateType("Unknown.tt", ParsedTargetFramework));
    }
    ...
    {
        var path = BlazorCrudHelper.GetBaseOutputPath("Product", _testProjectPath);
    ...
    {
        var path1 = BlazorCrudHelper.GetBaseOutputPath("Product", _testProjectPath);
        var path2 = BlazorCrudHelper.GetBaseOutputPath("Customer", _testProjectPath);
