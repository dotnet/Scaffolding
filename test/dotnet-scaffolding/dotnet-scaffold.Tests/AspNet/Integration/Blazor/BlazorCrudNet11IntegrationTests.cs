...
/// <summary>
/// Integration tests for the Blazor CRUD (blazor-crud) scaffolder targeting .NET 11.
...
/// .NET 11 includes the NotFound template in the BlazorCrud template folder alongside
/// Create, Delete, Details, Edit, and Index (same as .NET 10).
/// </summary>
public class BlazorCrudNet11IntegrationTests : IDisposable
{
    ...
    public BlazorCrudNet11IntegrationTests()
    {
        _testDirectory = Path.Combine(Path.GetTempPath(), "BlazorCrudNet11IntegrationTests", Guid.NewGuid().ToString());
    ...
    [Fact]
    public void ScaffolderName_IsBlazorCrud_Net11()
    {
        Assert.Equal("blazor-crud", AspnetStrings.Blazor.Crud);
    }

    [Fact]
    public void ScaffolderDisplayName_IsRazorComponentsWithEntityFrameworkCoreCRUD_Net11()
    {
        Assert.Equal("Razor Components with EntityFrameworkCore (CRUD)", AspnetStrings.Blazor.CrudDisplayName);
    }

    [Fact]
    public void ScaffolderDescription_DescribesCrudGeneration_Net11()
    {
    ...
    [Fact]
    public void ScaffolderDescription_MentionsAllCrudOperations_Net11()
    {
        Assert.Contains("Create", AspnetStrings.Blazor.CrudDescription);
        Assert.Contains("Delete", AspnetStrings.Blazor.CrudDescription);
    ...
    [Fact]
    public void ScaffolderExample1_ContainsBlazorCrudCommand_Net11()
    {
    ...
    [Fact]
    public void ScaffolderExample2_ContainsBlazorCrudCommand_Net11()
    {
        Assert.Contains("blazor-crud", AspnetStrings.Blazor.CrudExample2);
    }

    [Fact]
    public void ScaffolderExampleDescriptions_AreNotEmpty_Net11()
    {
    ...
    [Fact]
    public void BlazorCrud_IsDifferentFromBlazorEmpty_Net11()
    {
        Assert.NotEqual(AspnetStrings.Blazor.Crud, AspnetStrings.Blazor.Empty);
    }

    [Fact]
    public void BlazorCrud_IsDifferentFromBlazorIdentity_Net11()
    {
        Assert.NotEqual(AspnetStrings.Blazor.Crud, AspnetStrings.Blazor.Identity);
    }

    [Fact]
    public void BlazorCrud_BlazorExtensionConstant_IsRazor_Net11()
    {
    ...
    [Fact]
    public async Task ExecuteAsync_ReturnsFalse_WhenProjectIsNull_Net11()
    {
    ...
    [Fact]
    public async Task ExecuteAsync_ReturnsFalse_WhenProjectIsEmpty_Net11()
    {
        var step = new ValidateBlazorCrudStep(
            _mockFileSystem.Object,
            NullLogger<ValidateBlazorCrudStep>.Instance,
    ...
    [Fact]
    public async Task ExecuteAsync_ReturnsFalse_WhenProjectDoesNotExist_Net11()
    {
    ...
    [Fact]
    public async Task ExecuteAsync_ReturnsFalse_WhenModelIsNull_Net11()
    {
    ...
    [Fact]
    public async Task ExecuteAsync_ReturnsFalse_WhenModelIsEmpty_Net11()
    {
        _mockFileSystem.Setup(fs => fs.FileExists(_testProjectPath)).Returns(true);
    ...
    [Fact]
    public async Task ExecuteAsync_ReturnsFalse_WhenPageIsNull_Net11()
    {
        _mockFileSystem.Setup(fs => fs.FileExists(_testProjectPath)).Returns(true);
    ...
    [Fact]
    public async Task ExecuteAsync_ReturnsFalse_WhenPageIsEmpty_Net11()
    {
        _mockFileSystem.Setup(fs => fs.FileExists(_testProjectPath)).Returns(true);
    ...
    [Fact]
    public async Task ExecuteAsync_ReturnsFalse_WhenDataContextIsNull_Net11()
    {
        _mockFileSystem.Setup(fs => fs.FileExists(_testProjectPath)).Returns(true);
    ...
    [Fact]
    public async Task ExecuteAsync_ReturnsFalse_WhenDataContextIsEmpty_Net11()
    {
        _mockFileSystem.Setup(fs => fs.FileExists(_testProjectPath)).Returns(true);
    ...
    [Fact]
    public async Task ExecuteAsync_TracksTelemetryEvent_OnValidationFailure_NullProject_Net11()
    {
    ...
    [Fact]
    public async Task ExecuteAsync_TracksTelemetryEvent_OnValidationFailure_NullModel_Net11()
    {
        _mockFileSystem.Setup(fs => fs.FileExists(_testProjectPath)).Returns(true);
        var telemetry = new TestTelemetryService();
    ...
    [Fact]
    public async Task ExecuteAsync_TracksTelemetryEvent_WithScaffolderDisplayName_Net11()
    {
        var telemetry = new TestTelemetryService();
        var step = new ValidateBlazorCrudStep(
            _mockFileSystem.Object,
    ...
    [Fact]
    public async Task ExecuteAsync_AcceptsCancellationToken_WithoutThrowing_Net11()
    {
        var step = new ValidateBlazorCrudStep(
            _mockFileSystem.Object,
            NullLogger<ValidateBlazorCrudStep>.Instance,
    ...
    [InlineData("enum[]", "InputSelect")]
    public void GetInputType_ReturnsCorrectBlazorInputComponent_Net11(string dotnetType, string expectedInputType)
    {
    ...
    [Fact]
    public void GetInputType_ReturnsInputText_ForUnknownType_Net11()
    {
        var model = CreateTestBlazorCrudModel();
    ...
    [Fact]
    public void GetInputType_ReturnsInputText_ForNullInput_Net11()
    {
        var model = CreateTestBlazorCrudModel();
    ...
    [Fact]
    public void GetInputType_ReturnsInputText_ForEmptyInput_Net11()
    {
        var model = CreateTestBlazorCrudModel();
    ...
    [Fact]
    public void GetInputClassType_ReturnsFormCheckInput_ForBool_Net11()
    {
        var model = CreateTestBlazorCrudModel();
    ...
    [Fact]
    public void GetInputClassType_ReturnsFormControl_ForString_Net11()
    {
        var model = CreateTestBlazorCrudModel();
    ...
    [Fact]
    public void GetInputClassType_ReturnsFormControl_ForInt_Net11()
    {
        var model = CreateTestBlazorCrudModel();
    ...
    [Fact]
    public void GetInputClassType_ReturnsFormControl_ForDateTime_Net11()
    {
        var model = CreateTestBlazorCrudModel();
    ...
    [InlineData("Bool")]
    [InlineData("BOOL")]
    public void GetInputClassType_IsCaseInsensitive_ForBool_Net11(string boolVariant)
    {
        var model = CreateTestBlazorCrudModel();
    ...
    [Fact]
    public void BlazorCrudModel_HasMainLayout_DefaultsFalse_Net11()
    {
        var model = CreateTestBlazorCrudModel();
    ...
    [Fact]
    public void BlazorCrudModel_HasMainLayout_CanBeSetToTrue_Net11()
    {
        var model = CreateTestBlazorCrudModel();
    ...
    [Fact]
    public void BlazorCrudModel_PageType_CanBeRead_Net11()
    {
        var model = CreateTestBlazorCrudModel();
    ...
    [Fact]
    public void BlazorCrudModel_ModelInfo_IsNotNull_Net11()
    {
        var model = CreateTestBlazorCrudModel();
    ...
    [Fact]
    public void BlazorCrudModel_DbContextInfo_IsNotNull_Net11()
    {
        var model = CreateTestBlazorCrudModel();
    ...
    [Fact]
    public void GetTemplateType_WithCreateTemplate_ReturnsNonNull_Net11()
    {
        string templatePath = Path.Combine("templates", BlazorCrudHelper.CreateBlazorTemplate);
        Type? result = BlazorCrudHelper.GetTemplateType(templatePath, Microsoft.DotNet.Scaffolding.Core.Model.TargetFramework.Net11);
        Assert.NotNull(result);
    }

    [Fact]
    public void GetTemplateType_WithDeleteTemplate_ReturnsNonNull_Net11()
    {
    ...
    [Fact]
    public void GetTemplateType_WithDetailsTemplate_ReturnsNonNull_Net11()
    {
    ...
    [Fact]
    public void GetTemplateType_WithEditTemplate_ReturnsNonNull_Net11()
    {
    ...
    [Fact]
    public void GetTemplateType_WithIndexTemplate_ReturnsNonNull_Net11()
    {
    ...
    [Fact]
    public void GetTemplateType_WithNotFoundTemplate_ReturnsNonNull_Net11()
    {
    ...
    [Fact]
    public void GetTemplateType_WithNull_ReturnsNull_Net11()
    {
        Type? result = BlazorCrudHelper.GetTemplateType(null, Microsoft.DotNet.Scaffolding.Core.Model.TargetFramework.Net11);
        Assert.Null(result);
    }

    [Fact]
    public void GetTemplateType_WithEmpty_ReturnsNull_Net11()
    {
        Type? result = BlazorCrudHelper.GetTemplateType(string.Empty, Microsoft.DotNet.Scaffolding.Core.Model.TargetFramework.Net11);
        Assert.Null(result);
    }

    [Fact]
    public void GetTemplateType_WithUnknownTemplate_ReturnsNull_Net11()
    {
        Type? result = BlazorCrudHelper.GetTemplateType(Path.Combine("templates", "Unknown.tt"), Microsoft.DotNet.Scaffolding.Core.Model.TargetFramework.Net11);
        Assert.Null(result);
    }
    ...
    public void IsValidTemplate_ReturnsExpectedResult_Net11(string templateType, string templateFileName, bool expected)
    {
    ...
    [Fact]
    public void IsValidTemplate_CRUDType_AlwaysReturnsTrue_RegardlessOfFileName_Net11()
    {
    ...
    public void IsValidTemplate_IsCaseInsensitive_Net11(string templateType, string templateFileName)
    {
        bool result = BlazorCrudHelper.IsValidTemplate(templateType, templateFileName);
        Assert.True(result);
    }
    ...
    [Fact]
    public void GetBaseOutputPath_WithValidInputs_ContainsComponentsPagesModelPages_Net11()
    {
    ...
    [Fact]
    public void GetBaseOutputPath_WithNullProjectPath_StillReturnsPath_Net11()
    {
        string modelName = "Product";
    ...
    [Fact]
    public void GetBaseOutputPath_ModelName_AppendedAsModelNamePages_Net11()
    {
    ...
    [Fact]
    public void GetBaseOutputPath_DifferentModels_ProduceDifferentPaths_Net11()
    {
        string projectPath = Path.Combine("C:", "TestApp", "TestApp.csproj");
    ...
    [Fact]
    public void CRUDPages_ContainsAllSevenPageTypes_Net11()
    {
        Assert.Equal(7, BlazorCrudHelper.CRUDPages.Count);
    }

    [Fact]
    public void CRUDPages_ContainsCRUD_Net11()
    {
        Assert.Contains("CRUD", BlazorCrudHelper.CRUDPages);
    }

    [Fact]
    public void CRUDPages_ContainsCreate_Net11()
    {
        Assert.Contains("Create", BlazorCrudHelper.CRUDPages);
    }

    [Fact]
    public void CRUDPages_ContainsDelete_Net11()
    {
        Assert.Contains("Delete", BlazorCrudHelper.CRUDPages);
    }

    [Fact]
    public void CRUDPages_ContainsDetails_Net11()
    {
        Assert.Contains("Details", BlazorCrudHelper.CRUDPages);
    }

    [Fact]
    public void CRUDPages_ContainsEdit_Net11()
    {
        Assert.Contains("Edit", BlazorCrudHelper.CRUDPages);
    }

    [Fact]
    public void CRUDPages_ContainsIndex_Net11()
    {
    ...
    [Fact]
    public void CreateBlazorTemplate_HasExpectedValue_Net11()
    {
        Assert.Equal("Create.tt", BlazorCrudHelper.CreateBlazorTemplate);
    }

    [Fact]
    public void DeleteBlazorTemplate_HasExpectedValue_Net11()
    {
        Assert.Equal("Delete.tt", BlazorCrudHelper.DeleteBlazorTemplate);
    }

    [Fact]
    public void DetailsBlazorTemplate_HasExpectedValue_Net11()
    {
        Assert.Equal("Details.tt", BlazorCrudHelper.DetailsBlazorTemplate);
    }

    [Fact]
    public void EditBlazorTemplate_HasExpectedValue_Net11()
    {
        Assert.Equal("Edit.tt", BlazorCrudHelper.EditBlazorTemplate);
    }

    [Fact]
    public void IndexBlazorTemplate_HasExpectedValue_Net11()
    {
        Assert.Equal("Index.tt", BlazorCrudHelper.IndexBlazorTemplate);
    }

    [Fact]
    public void NotFoundBlazorTemplate_HasExpectedValue_Net11()
    {
    ...
    #region BlazorCrudHelper — Net11 Template Folder Verification

    [Fact]
    public void Net11TemplateFolderContainsNotFoundTemplate()
    {
        // Verify the net11.0 BlazorCrud template folder includes the NotFound template
        // (present in net10.0+ template folders, absent in net8.0/net9.0).
        string templateFolder = Path.Combine(
            AppDomain.CurrentDomain.BaseDirectory,
            "AspNet", "Templates", "net11.0", "BlazorCrud");

        if (Directory.Exists(templateFolder))
        {
            string notFoundPath = Path.Combine(templateFolder, "NotFound.tt");
            Assert.True(File.Exists(notFoundPath),
                "net11.0 BlazorCrud template folder should contain NotFound.tt");
        }
    }

    [Fact]
    public void Net11TemplateFolderContainsAllSixTemplates()
    {
        // net11.0 should have 6 .tt templates: Create, Delete, Details, Edit, Index, NotFound
        string templateFolder = Path.Combine(
            AppDomain.CurrentDomain.BaseDirectory,
            "AspNet", "Templates", "net11.0", "BlazorCrud");
        ...
        if (Directory.Exists(templateFolder))
        {
            ...
            foreach (var template in expectedTemplates)
            {
                Assert.True(File.Exists(Path.Combine(templateFolder, template)),
                    $"net11.0 BlazorCrud template folder should contain {template}");
            }
        }
    }
    ...
    [Fact]
    public void AddRazorComponentsSnippet_ContainsExpectedMethod_Net11()
    {
        Assert.Contains("AddRazorComponents()", BlazorCrudHelper.AddRazorComponentsSnippet);
    }

    [Fact]
    public void AddRazorComponentsSnippet_ContainsInsertBeforeMarker_Net11()
    {
    ...
    [Fact]
    public void IServiceCollectionType_HasExpectedFullyQualifiedName_Net11()
    {
        Assert.Equal("Microsoft.Extensions.DependencyInjection.IServiceCollection", BlazorCrudHelper.IServiceCollectionType);
    }

    [Fact]
    public void RazorComponentsEndpointsConventionBuilderType_HasExpectedFullyQualifiedName_Net11()
    {
    ...
    [Fact]
    public void IEndpointRouteBuilderContainingType_HasExpectedFullyQualifiedName_Net11()
    {
        Assert.Equal("Microsoft.AspNetCore.Routing.IEndpointRouteBuilder", BlazorCrudHelper.IEndpointRouteBuilderContainingType);
    }

    [Fact]
    public void IServerSideBlazorBuilderType_HasExpectedFullyQualifiedName_Net11()
    {
    ...
    [Fact]
    public void GlobalServerRenderModeText_ContainsInteractiveServer_Net11()
    {
    ...
    [Fact]
    public void GlobalWebAssemblyRenderModeText_ContainsInteractiveWebAssembly_Net11()
    {
    ...
    [Fact]
    public void GlobalServerRenderModeRoutesText_ContainsRoutes_Net11()
    {
    ...
    [Fact]
    public void GlobalWebAssemblyRenderModeRoutesText_ContainsRoutes_Net11()
    {
    ...
    [Fact]
    public void GetTextTemplatingProperties_WithEmptyTemplatePaths_ReturnsEmpty_Net11()
    {
    ...
    [Fact]
    public void GetTextTemplatingProperties_WithValidCRUDType_GeneratesPropertiesForMatchingTemplates_Net11()
    {
        var model = CreateTestBlazorCrudModelWithProjectInfo();
    ...
    [Fact]
    public void GetTextTemplatingProperties_WithAllSixTemplatesIncludingNotFound_Net11()
    {
        // Net11 includes the NotFound template in its template folder (same as net10).
    ...
    [Fact]
    public void GetTextTemplatingProperties_WithSpecificPageType_OnlyGeneratesMatchingTemplate_Net11()
    {
        var model = new BlazorCrudModel
        {
            PageType = "Create",
    ...
    [Fact]
    public void GetTextTemplatingProperties_OutputPaths_ContainModelNamePages_Net11()
    {
        var model = CreateTestBlazorCrudModelWithProjectInfo();
        var templatePaths = new[]
        {
    ...
    [Fact]
    public void GetTextTemplatingProperties_NotFoundTemplate_OutputsToComponentsPages_Net11()
    {
        var model = CreateTestBlazorCrudModelWithProjectInfo();
        var templatePaths = new[]
        {
    ...
    [Fact]
    public void BlazorCrudAppProperties_DefaultsToAllFalse_Net11()
    {
    ...
    [Fact]
    public void BlazorCrudAppProperties_PropertiesCanBeSet_Net11()
    {
        var props = new BlazorCrudAppProperties
        {
    ...
    [Fact]
    public void ModelInfo_ModelTypeNameCapitalized_CapitalizesFirstLetter_Net11()
    {
    ...
    [Fact]
    public void ModelInfo_ModelTypePluralName_AppendsSuffix_Net11()
    {
        var modelInfo = new ModelInfo { ModelTypeName = "Product" };
    ...
    [Fact]
    public void ModelInfo_ModelVariable_IsLowercase_Net11()
    {
        var modelInfo = new ModelInfo { ModelTypeName = "Product" };
    ...
    [Fact]
    public void DbContextInfo_EfScenario_DefaultsFalse_Net11()
    {
    ...
    [Fact]
    public void DbContextInfo_CanSetAllProperties_Net11()
    {
        var dbContextInfo = new DbContextInfo
        {
    ...
    [Fact]
    public void AspNetCoreDiagnosticsEfCorePackage_HasCorrectName_Net11()
    {
    ...
    [Fact]
    public void EfCoreToolsPackage_HasCorrectName_Net11()
    {
    ...
    [Fact]
    public void WithBlazorCrudTextTemplatingStep_ReturnsBuilder_Net11()
    {
    ...
    [Fact]
    public void GetScaffoldSteps_ContainsValidateBlazorCrudStep_Net11()
    {
    ...
    [Fact]
    public void GetScaffoldSteps_ContainsWrappedTextTemplatingStep_Net11()
    {
        var mockRunnerBuilder = new Mock<IScaffoldRunnerBuilder>();
        var service = new AspNetCommandService(mockRunnerBuilder.Object);
    ...
    [Fact]
    public void GetScaffoldSteps_ContainsWrappedAddPackagesStep_Net11()
    {
        var mockRunnerBuilder = new Mock<IScaffoldRunnerBuilder>();
        var service = new AspNetCommandService(mockRunnerBuilder.Object);
    ...
    [Fact]
    public void GetScaffoldSteps_ContainsWrappedCodeModificationStep_Net11()
    {
        var mockRunnerBuilder = new Mock<IScaffoldRunnerBuilder>();
        var service = new AspNetCommandService(mockRunnerBuilder.Object);
    ...
    [Fact]
    public void CrudSettings_CanBeCreated_WithRequiredProperties_Net11()
    {
    ...
    [Fact]
    public void CrudSettings_Prerelease_CanBeSetToTrue_Net11()
    {
        var settings = new CrudSettings
        {
            Project = _testProjectPath,
    ...
    [Fact]
    public void CrudSettings_Page_SupportsAllPageTypes_Net11()
    {
    ...
    [Fact]
    public async Task RegressionGuard_AllNullInputs_DoNotThrow_Net11()
    {
        var step = new ValidateBlazorCrudStep(
            _mockFileSystem.Object,
            NullLogger<ValidateBlazorCrudStep>.Instance,
    ...
    [Fact]
    public async Task RegressionGuard_AllEmptyInputs_DoNotThrow_Net11()
    {
        var step = new ValidateBlazorCrudStep(
            _mockFileSystem.Object,
            NullLogger<ValidateBlazorCrudStep>.Instance,
    ...
    [Fact]
    public async Task RegressionGuard_NonExistentProject_ReturnsFalseNotException_Net11()
    {
        _mockFileSystem.Setup(fs => fs.FileExists(It.IsAny<string>())).Returns(false);
    ...
    [Fact]
    public void RegressionGuard_GetTemplateType_AllTemplatesReturnNonNull_Net11()
    {
        ...
        {
            var result = BlazorCrudHelper.GetTemplateType(Path.Combine("any", template), Microsoft.DotNet.Scaffolding.Core.Model.TargetFramework.Net11);
            Assert.NotNull(result);
        }
    }

    [Fact]
    public void RegressionGuard_CRUDPages_ListHasNoDuplicates_Net11()
    {
