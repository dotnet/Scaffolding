...
/// <summary>
/// Integration tests for the Blazor CRUD (blazor-crud) scaffolder targeting .NET 8.
...
/// </summary>
public class BlazorCrudNet8IntegrationTests : IDisposable
{
    ...
    public BlazorCrudNet8IntegrationTests()
    {
        _testDirectory = Path.Combine(Path.GetTempPath(), "BlazorCrudNet8IntegrationTests", Guid.NewGuid().ToString());
    ...
    [Fact]
    public void ScaffolderName_IsBlazorCrud()
    {
        Assert.Equal("blazor-crud", AspnetStrings.Blazor.Crud);
    }

    [Fact]
    public void ScaffolderDisplayName_IsRazorComponentsWithEntityFrameworkCoreCRUD()
    {
        Assert.Equal("Razor Components with EntityFrameworkCore (CRUD)", AspnetStrings.Blazor.CrudDisplayName);
    }

    [Fact]
    public void ScaffolderDescription_DescribesCrudGeneration()
    {
    ...
    [Fact]
    public void ScaffolderDescription_MentionsAllCrudOperations()
    {
        Assert.Contains("Create", AspnetStrings.Blazor.CrudDescription);
        Assert.Contains("Delete", AspnetStrings.Blazor.CrudDescription);
    ...
    [Fact]
    public void ScaffolderExample1_ContainsBlazorCrudCommand()
    {
        Assert.Contains("blazor-crud", AspnetStrings.Blazor.CrudExample1);
    }

    [Fact]
    public void ScaffolderExample1_ContainsRequiredOptions()
    {
    ...
    [Fact]
    public void ScaffolderExample2_ContainsBlazorCrudCommand()
    {
        Assert.Contains("blazor-crud", AspnetStrings.Blazor.CrudExample2);
    }

    [Fact]
    public void ScaffolderExampleDescriptions_AreNotEmpty()
    {
    ...
    [Fact]
    public void BlazorCrud_IsDifferentFromBlazorEmpty()
    {
        Assert.NotEqual(AspnetStrings.Blazor.Crud, AspnetStrings.Blazor.Empty);
    }

    [Fact]
    public void BlazorCrud_IsDifferentFromBlazorIdentity()
    {
        Assert.NotEqual(AspnetStrings.Blazor.Crud, AspnetStrings.Blazor.Identity);
    }

    [Fact]
    public void BlazorCrud_BlazorExtensionConstant_IsRazor()
    {
    ...
    [Fact]
    public async Task ExecuteAsync_AcceptsCancellationToken_WithoutThrowing()
    {
        var step = new ValidateBlazorCrudStep(
            _mockFileSystem.Object,
            NullLogger<ValidateBlazorCrudStep>.Instance,
    ...
    [InlineData("enum[]", "InputSelect")]
    public void GetInputType_ReturnsCorrectBlazorInputComponent(string dotnetType, string expectedInputType)
    {
    ...
    [Fact]
    public void GetInputType_ReturnsInputText_ForUnknownType()
    {
        var model = CreateTestBlazorCrudModel();
    ...
    [Fact]
    public void GetInputType_ReturnsInputText_ForNullInput()
    {
        var model = CreateTestBlazorCrudModel();
    ...
    [Fact]
    public void GetInputType_ReturnsInputText_ForEmptyInput()
    {
        var model = CreateTestBlazorCrudModel();
    ...
    [Fact]
    public void GetInputClassType_ReturnsFormCheckInput_ForBool()
    {
        var model = CreateTestBlazorCrudModel();
    ...
    [Fact]
    public void GetInputClassType_ReturnsFormControl_ForString()
    {
        var model = CreateTestBlazorCrudModel();
    ...
    [Fact]
    public void GetInputClassType_ReturnsFormControl_ForInt()
    {
        var model = CreateTestBlazorCrudModel();
    ...
    [Fact]
    public void GetInputClassType_ReturnsFormControl_ForDateTime()
    {
        var model = CreateTestBlazorCrudModel();
    ...
    [InlineData("Bool")]
    [InlineData("BOOL")]
    public void GetInputClassType_IsCaseInsensitive_ForBool(string boolVariant)
    {
        var model = CreateTestBlazorCrudModel();
    ...
    [Fact]
    public void BlazorCrudModel_HasMainLayout_DefaultsFalse()
    {
        var model = CreateTestBlazorCrudModel();
    ...
    [Fact]
    public void BlazorCrudModel_HasMainLayout_CanBeSetToTrue()
    {
        var model = CreateTestBlazorCrudModel();
    ...
    [Fact]
    public void BlazorCrudModel_PageType_CanBeRead()
    {
        var model = CreateTestBlazorCrudModel();
    ...
    [Fact]
    public void BlazorCrudModel_ModelInfo_IsNotNull()
    {
        var model = CreateTestBlazorCrudModel();
    ...
    [Fact]
    public void BlazorCrudModel_DbContextInfo_IsNotNull()
    {
        var model = CreateTestBlazorCrudModel();
    ...
    {
        Type? result = BlazorCrudHelper.GetTemplateType(string.Empty, Microsoft.DotNet.Scaffolding.Core.Model.TargetFramework.Net8);
        Assert.Null(result);
    }
    ...
    {
        Type? result = BlazorCrudHelper.GetTemplateType(Path.Combine("templates", "Unknown.tt"), Microsoft.DotNet.Scaffolding.Core.Model.TargetFramework.Net8);
        Assert.Null(result);
    }
    ...
    public void IsValidTemplate_ReturnsExpectedResult(string templateType, string templateFileName, bool expected)
    {
    ...
    [Fact]
    public void IsValidTemplate_CRUDType_AlwaysReturnsTrue_RegardlessOfFileName()
    {
    ...
    public void IsValidTemplate_IsCaseInsensitive(string templateType, string templateFileName)
    {
        bool result = BlazorCrudHelper.IsValidTemplate(templateType, templateFileName);
        Assert.True(result);
    }
    ...
    [Fact]
    public void GetBaseOutputPath_WithNullProjectPath_StillReturnsPath()
    {
        string modelName = "Product";
    ...
    [Fact]
    public void GetBaseOutputPath_ModelName_AppendedAsModelNamePages()
    {
    ...
    [Fact]
    public void AddRazorComponentsSnippet_ContainsExpectedMethod()
    {
        Assert.Contains("AddRazorComponents()", BlazorCrudHelper.AddRazorComponentsSnippet);
    }

    [Fact]
    public void AddRazorComponentsSnippet_ContainsInsertBeforeMarker()
    {
    ...
    [Fact]
    public void IServiceCollectionType_HasExpectedFullyQualifiedName()
    {
        Assert.Equal("Microsoft.Extensions.DependencyInjection.IServiceCollection", BlazorCrudHelper.IServiceCollectionType);
    }

    [Fact]
    public void RazorComponentsEndpointsConventionBuilderType_HasExpectedFullyQualifiedName()
    {
    ...
    [Fact]
    public void IEndpointRouteBuilderContainingType_HasExpectedFullyQualifiedName()
    {
        Assert.Equal("Microsoft.AspNetCore.Routing.IEndpointRouteBuilder", BlazorCrudHelper.IEndpointRouteBuilderContainingType);
    }

    [Fact]
    public void IServerSideBlazorBuilderType_HasExpectedFullyQualifiedName()
    {
    ...
    [Fact]
    public void GlobalServerRenderModeText_ContainsInteractiveServer()
    {
    ...
    [Fact]
    public void GlobalWebAssemblyRenderModeText_ContainsInteractiveWebAssembly()
    {
    ...
    [Fact]
    public void GlobalServerRenderModeRoutesText_ContainsRoutes()
    {
    ...
    [Fact]
    public void GlobalWebAssemblyRenderModeRoutesText_ContainsRoutes()
    {
    ...
    [Fact]
    public void GetTextTemplatingProperties_WithValidCRUDType_GeneratesPropertiesForMatchingTemplates()
    {
        var model = CreateTestBlazorCrudModelWithProjectInfo();
    ...
    [Fact]
    public void GetTextTemplatingProperties_WithSpecificPageType_OnlyGeneratesMatchingTemplate()
    {
        var model = new BlazorCrudModel
        {
            PageType = "Create",
    ...
    [Fact]
    public void GetTextTemplatingProperties_OutputPaths_ContainModelNamePages()
    {
        var model = CreateTestBlazorCrudModelWithProjectInfo();
        var templatePaths = new[]
        {
    ...
    [Fact]
    public void GetTextTemplatingProperties_NotFoundTemplate_OutputsToComponentsPages()
    {
        var model = CreateTestBlazorCrudModelWithProjectInfo();
        var templatePaths = new[]
        {
    ...
    [Fact]
    public void BlazorCrudAppProperties_DefaultsToAllFalse()
    {
    ...
    [Fact]
    public void BlazorCrudAppProperties_PropertiesCanBeSet()
    {
        var props = new BlazorCrudAppProperties
        {
    ...
    [Fact]
    public void ModelInfo_ModelTypeNameCapitalized_CapitalizesFirstLetter()
    {
    ...
    [Fact]
    public void ModelInfo_ModelTypePluralName_AppendsSuffix()
    {
        var modelInfo = new ModelInfo { ModelTypeName = "Product" };
    ...
    [Fact]
    public void ModelInfo_ModelVariable_IsLowercase()
    {
        var modelInfo = new ModelInfo { ModelTypeName = "Product" };
    ...
    [Fact]
    public void DbContextInfo_EfScenario_DefaultsFalse()
    {
    ...
    [Fact]
    public void DbContextInfo_CanSetAllProperties()
    {
        var dbContextInfo = new DbContextInfo
        {
    ...
    [Fact]
    public void AspNetCoreDiagnosticsEfCorePackage_HasCorrectName()
    {
    ...
    [Fact]
    public void EfCoreToolsPackage_HasCorrectName()
    {
    ...
    [Fact]
    public void GetScaffoldSteps_ContainsValidateBlazorCrudStep()
    {
    ...
    [Fact]
    public void GetScaffoldSteps_ContainsWrappedTextTemplatingStep()
    {
        var mockRunnerBuilder = new Mock<IScaffoldRunnerBuilder>();
        var service = new AspNetCommandService(mockRunnerBuilder.Object);
    ...
    [Fact]
    public void GetScaffoldSteps_ContainsWrappedAddPackagesStep()
    {
        var mockRunnerBuilder = new Mock<IScaffoldRunnerBuilder>();
        var service = new AspNetCommandService(mockRunnerBuilder.Object);
    ...
    [Fact]
    public void GetScaffoldSteps_ContainsWrappedCodeModificationStep()
    {
        var mockRunnerBuilder = new Mock<IScaffoldRunnerBuilder>();
        var service = new AspNetCommandService(mockRunnerBuilder.Object);
    ...
    [Fact]
    public void CrudSettings_CanBeCreated_WithRequiredProperties()
    {
    ...
    [Fact]
    public void CrudSettings_Prerelease_CanBeSetToTrue()
    {
        var settings = new CrudSettings
        {
            Project = _testProjectPath,
    ...
    [Fact]
    public void CrudSettings_Page_SupportsAllPageTypes()
    {
    ...
    [Fact]
    public async Task RegressionGuard_AllNullInputs_DoNotThrow()
    {
        var step = new ValidateBlazorCrudStep(
            _mockFileSystem.Object,
            NullLogger<ValidateBlazorCrudStep>.Instance,
    ...
    [Fact]
    public async Task RegressionGuard_AllEmptyInputs_DoNotThrow()
    {
        var step = new ValidateBlazorCrudStep(
            _mockFileSystem.Object,
            NullLogger<ValidateBlazorCrudStep>.Instance,
