...
public class BlazorIdentityNet10IntegrationTests : BlazorIdentityIntegrationTestsBase
{
    ...
    [Fact]
    public async Task Scaffold_BlazorIdentity_Net10_BuildsAndValidates()
    {
        // Arrange - write a real project file
        ...
        // Scaffold - use ValidateIdentityStep with BlazorScenario = true and real FileSystem
