...
public abstract class IdentityIntegrationTestsBase : IDisposable
{
  ...
  <PropertyGroup>
    ...
    [Fact]
    public virtual void Identity_Bootstrap5_FolderExists()
    {
    ...
    [Fact]
    public virtual void Identity_Bootstrap4_FolderExists()
    {
        var basePath = GetActualTemplatesBasePath();
    ...
    [Fact]
    public virtual void Identity_Bootstrap5_HasFiles()
    {
        var basePath = GetActualTemplatesBasePath();
        var bs5Dir = Path.Combine(basePath, TargetFramework, "Identity", "Bootstrap5");
    ...
    [Fact]
    public virtual void Identity_Bootstrap4_HasFiles()
    {
        var basePath = GetActualTemplatesBasePath();
        var bs4Dir = Path.Combine(basePath, TargetFramework, "Identity", "Bootstrap4");
    ...
    [Fact]
    public virtual void Identity_Bootstrap5_HasMoreOrEqualFilesThanBootstrap4()
    {
        var basePath = GetActualTemplatesBasePath();
    ...
    [Fact]
    public virtual void IdentityMinimalHostingChangesConfig_ExistsForTargetFramework()
    {
    ...
    [Fact]
    public virtual void IdentityMinimalHostingChangesConfig_IsNotEmpty()
    {
        var configPath = GetIdentityMinimalHostingChangesConfigPath();
    ...
    [Fact]
    public virtual void IdentityMinimalHostingChangesConfig_ReferencesProgramCs()
    {
        var configPath = GetIdentityMinimalHostingChangesConfigPath();
        var content = File.ReadAllText(configPath);
