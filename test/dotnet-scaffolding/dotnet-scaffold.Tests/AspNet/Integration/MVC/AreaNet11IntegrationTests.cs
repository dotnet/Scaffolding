...
public class AreaNet11IntegrationTests : AreaIntegrationTestsBase
{
    protected override string TargetFramework => "net11.0";
    protected override string TestClassName => nameof(AreaNet11IntegrationTests);

    [Fact]
    public async Task ExecuteAsync_ScaffoldsCorrectDirectoriesAndBuilds_Net11()
    {
