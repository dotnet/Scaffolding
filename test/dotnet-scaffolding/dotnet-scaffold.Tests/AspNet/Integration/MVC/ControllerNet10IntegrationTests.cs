...
/// <summary>
/// .NET 10-specific integration tests for the MVC Empty Controller scaffolder.
/// Inherits shared tests from <see cref="ControllerIntegrationTestsBase"/>.
/// </summary>
public class ControllerNet10IntegrationTests : ControllerIntegrationTestsBase
{
    protected override string TargetFramework => "net10.0";
    protected override string TestClassName => nameof(ControllerNet10IntegrationTests);

    [Fact]
    public async Task Scaffold_MvcController_Net10_CliInvocation()
    {
