...
/// <summary>
/// .NET 11-specific integration tests for the MVC Empty Controller scaffolder.
/// Inherits shared tests from <see cref="ControllerIntegrationTestsBase"/>.
/// </summary>
public class ControllerNet11IntegrationTests : ControllerIntegrationTestsBase
{
    protected override string TargetFramework => "net11.0";
    protected override string TestClassName => nameof(ControllerNet11IntegrationTests);

    [Fact]
    public async Task Scaffold_MvcController_Net11_CliInvocation()
    {
