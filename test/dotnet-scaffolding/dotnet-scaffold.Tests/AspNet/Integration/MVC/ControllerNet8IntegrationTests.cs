...
/// <summary>
/// .NET 8-specific integration tests for the MVC Empty Controller scaffolder.
/// Inherits shared tests from <see cref="ControllerIntegrationTestsBase"/>.
/// </summary>
public class ControllerNet8IntegrationTests : ControllerIntegrationTestsBase
{
    protected override string TargetFramework => "net8.0";
    protected override string TestClassName => nameof(ControllerNet8IntegrationTests);

    [Fact]
    public async Task Scaffold_MvcController_Net8_CliInvocation()
    {
        ...
        // Act - invoke CLI: dotnet scaffold aspnet mvccontroller
