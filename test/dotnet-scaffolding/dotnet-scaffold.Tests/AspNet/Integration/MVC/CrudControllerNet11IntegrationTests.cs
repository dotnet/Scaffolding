...
public class CrudControllerNet11IntegrationTests : CrudControllerIntegrationTestsBase
{
    protected override string TargetFramework => "net11.0";
    protected override string TestClassName => nameof(CrudControllerNet11IntegrationTests);

    [Fact]
    public async Task Scaffold_CrudController_Net11_BuildsAndValidates()
    {
        // Arrange  create a real project
        File.WriteAllText(_testProjectPath, ProjectContent);

        // Act  verify project builds before scaffolding
        ...
        // Scaffold  use ValidateEfControllerStep with real FileSystem (returns false since model class doesn't exist)
        var realFileSystem = new FileSystem();
        var step = new ValidateEfControllerStep(
            realFileSystem,
        ...
        step.ControllerName = "TestController";
