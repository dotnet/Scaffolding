...
public class CrudControllerNet8IntegrationTests : CrudControllerIntegrationTestsBase
{
    protected override string TargetFramework => "net8.0";
    protected override string TestClassName => nameof(CrudControllerNet8IntegrationTests);

    [Fact]
    public async Task Scaffold_CrudController_Net8_BuildsAndValidates()
    {
