...
/// <summary>
/// .NET 11-specific integration tests for the Razor View Empty (razorview-empty) scaffolder.
/// Inherits shared tests from <see cref="RazorViewEmptyIntegrationTestsBase"/>.
/// </summary>
public class RazorViewEmptyNet11IntegrationTests : RazorViewEmptyIntegrationTestsBase
{
    protected override string TargetFramework => "net11.0";
    protected override string TestClassName => nameof(RazorViewEmptyNet11IntegrationTests);

    [Fact]
    public async Task Scaffold_RazorViewEmpty_Net11_CliInvocation()
    {
