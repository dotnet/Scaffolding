...
/// <summary>
/// .NET 8-specific integration tests for the Razor View Empty (razorview-empty) scaffolder.
/// Inherits shared tests from <see cref="RazorViewEmptyIntegrationTestsBase"/>.
/// </summary>
public class RazorViewEmptyNet8IntegrationTests : RazorViewEmptyIntegrationTestsBase
{
    protected override string TargetFramework => "net8.0";
    protected override string TestClassName => nameof(RazorViewEmptyNet8IntegrationTests);

    [Fact]
    public async Task Scaffold_RazorViewEmpty_Net8_CliInvocation()
    {
        ...
        // Act invoke CLI: dotnet scaffold aspnet razorview-empty
