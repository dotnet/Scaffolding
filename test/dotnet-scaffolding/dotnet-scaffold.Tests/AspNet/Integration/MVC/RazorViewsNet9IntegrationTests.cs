...
public class RazorViewsNet9IntegrationTests : RazorViewsIntegrationTestsBase
{
    protected override string TargetFramework => "net9.0";
    protected override string TestClassName => nameof(RazorViewsNet9IntegrationTests);

    [Fact]
    public async Task ValidateViewsStep_ValidatesAndBuilds_Net9()
    {
