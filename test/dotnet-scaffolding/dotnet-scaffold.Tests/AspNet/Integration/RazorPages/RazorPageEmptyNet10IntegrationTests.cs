...
/// <summary>
/// .NET 10-specific integration tests for the Razor Page Empty (razorpage-empty) scaffolder.
/// Inherits shared tests from <see cref="RazorPageEmptyIntegrationTestsBase"/>.
/// </summary>
public class RazorPageEmptyNet10IntegrationTests : RazorPageEmptyIntegrationTestsBase
{
    protected override string TargetFramework => "net10.0";
    protected override string TestClassName => nameof(RazorPageEmptyNet10IntegrationTests);

    [Fact]
    public async Task Scaffold_RazorPageEmpty_Net10_CliInvocation()
    {
