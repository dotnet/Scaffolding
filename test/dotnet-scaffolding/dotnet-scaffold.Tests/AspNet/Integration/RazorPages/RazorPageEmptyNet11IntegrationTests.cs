...
/// <summary>
/// .NET 11-specific integration tests for the Razor Page Empty (razorpage-empty) scaffolder.
/// Inherits shared tests from <see cref="RazorPageEmptyIntegrationTestsBase"/>.
/// </summary>
public class RazorPageEmptyNet11IntegrationTests : RazorPageEmptyIntegrationTestsBase
{
    protected override string TargetFramework => "net11.0";
    protected override string TestClassName => nameof(RazorPageEmptyNet11IntegrationTests);

    [Fact]
    public async Task Scaffold_RazorPageEmpty_Net11_CliInvocation()
    {
