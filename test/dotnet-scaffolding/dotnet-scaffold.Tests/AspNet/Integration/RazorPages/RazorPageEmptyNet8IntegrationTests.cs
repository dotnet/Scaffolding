...
/// <summary>
/// .NET 8-specific integration tests for the Razor Page Empty (razorpage-empty) scaffolder.
/// Inherits shared tests from <see cref="RazorPageEmptyIntegrationTestsBase"/>.
/// </summary>
public class RazorPageEmptyNet8IntegrationTests : RazorPageEmptyIntegrationTestsBase
{
    protected override string TargetFramework => "net8.0";
    protected override string TestClassName => nameof(RazorPageEmptyNet8IntegrationTests);

    [Fact]
    public async Task Scaffold_RazorPageEmpty_Net8_CliInvocation()
    {
        ...
        // Act invoke CLI: dotnet scaffold aspnet razorpage-empty
