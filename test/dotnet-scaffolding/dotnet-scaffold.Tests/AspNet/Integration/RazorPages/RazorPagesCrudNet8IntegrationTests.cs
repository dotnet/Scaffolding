...
public class RazorPagesCrudNet8IntegrationTests : RazorPagesCrudIntegrationTestsBase
{
    protected override string TargetFramework => "net8.0";
    protected override string TestClassName => nameof(RazorPagesCrudNet8IntegrationTests);

    [Fact]
    public async Task Scaffold_RazorPagesCrud_Net8_BuildsAndValidates()
    {
        ...
        // Scaffold  use ValidateRazorPagesStep with real FileSystem (returns false since model class doesn't exist)
        var realFileSystem = new FileSystem();
        var step = new ValidateRazorPagesStep(
            realFileSystem,
