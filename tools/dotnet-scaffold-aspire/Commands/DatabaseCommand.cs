...
namespace Microsoft.DotNet.Tools.Scaffold.Aspire.Commands
{
    internal class DatabaseCommand : AsyncCommand<DatabaseCommand.DatabaseCommandSettings>
    {
        ...
        internal async Task<bool> UpdateAppHostAsync(DatabaseCommandSettings commandSettings)
        {
        ...
        internal async Task<bool> UpdateWebAppAsync(DatabaseCommandSettings commandSettings)
        {
            if (!MSBuildLocator.IsRegistered)
            {
                MSBuildLocator.RegisterDefaults();
        ...
        internal CodeModifierConfig? EditConfigForApiService(CodeModifierConfig? configToEdit, CodeChangeOptions codeChangeOptions, string dbType)
        {
            if (configToEdit is null)
            {
                return null;
